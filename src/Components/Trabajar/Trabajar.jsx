    ...
    <div className="trabajar">
      ...
      className="trabajar-info">
        <div className="trabajar-izq">
          ...
          <p>
            Nuestro enfoque se centra en brindar soluciones innovadoras y
            personalizadas a nuestros clientes, utilizando las últimas
            herramientas y tecnologías disponibles. Con un sólido historial de
            éxito en la implementación de proyectos tecnológicos, podemos
            garantizar resultados excepcionales y un enfoque centrado en la
            excelencia en cada paso del camino.
          </p>
        </div>
